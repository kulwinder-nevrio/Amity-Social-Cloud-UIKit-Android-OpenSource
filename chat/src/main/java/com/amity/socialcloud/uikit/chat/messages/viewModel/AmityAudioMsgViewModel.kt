...
class AmityAudioMsgViewModel : AmitySelectableMessageViewModel() {
    ...
    val senderFillColor = ObservableField(com.amity.socialcloud.uikit.common.R.color.amityMessageBubble)
    val receiverFillColor = ObservableField(com.amity.socialcloud.uikit.common.R.color.amityMessageBubbleInverse)
